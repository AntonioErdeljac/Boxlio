            ...
            <ContainerAnimatable ref="catalog" animation="fadeInDown" style={styles.container}>
                <Content>
                    ...
                    <CardItem>
                        ...
                        <TouchableOpacity onPress={() => this.handleRemoveFromBasket(item.uniqueID)} style={styles.button}>
                            <Grid>
                                <Row>
                                    <FAIcon name="close" style={{color: '#fff', marginRight: 10, fontSize: 14}} />
                                    <Text style={styles.textButton}>Remove from basket</Text>
                                </Row>
                            </Grid>
                        </TouchableOpacity>
                        </CardItem>
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketItemPreview);