...
class  SendRequestButton extends React.Component {
    ...
    render(){
    return (
        <TouchableOpacityAnimatable animation="fadeInUp" ref="searchbutton" onPress={() => this.refs.searchbutton.fadeOutDown(100).then(this.props.handleSendRequest)}  style={styles.loginButton}>
