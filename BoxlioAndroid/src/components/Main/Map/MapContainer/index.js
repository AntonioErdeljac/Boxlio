	...
	render(){
		return (
		    <Container style={styles.container}>
                ...
                { !this.props.currentUser.deliveryMode && !this.props.requestAccepted &&  !this.state.disableRequestComponents && this.props.placeFromChoosen && this.props.placeToChoosen && this.props.transportation !== '' && this.props.transportation !== null && this.props.profit && !this.props.basket || this.props.basket && this.props.basket.length === 0 ? <ShortMessage navigation={this.props.navigation} /> : null }
                { !this.props.currentUser.deliveryMode && !this.props.requestAccepted &&  !this.state.disableRequestComponents && this.props.placeFromChoosen && this.props.placeToChoosen && this.props.transportation !== '' && this.props.transportation !== null && this.props.profit && this.props.basket && this.props.basket.length > 0 ? <BasketPreview navigation={this.props.navigation} /> : null }
                { !this.props.currentUser.deliveryMode && !this.props.requestAccepted &&  !this.state.disableRequestComponents && this.props.placeFromChoosen && this.props.placeToChoosen && this.props.transportation !== '' && this.props.transportation !== null && this.props.profit && this.props.basket && this.props.basket.length > 0 ? <BasketButton navigation={this.props.navigation}/> : null }
                { !this.props.currentUser.deliveryMode && !this.props.requestAccepted &&  !this.state.disableRequestComponents && this.props.placeFromChoosen && this.props.placeToChoosen && this.props.transportation !== '' && this.props.transportation !== null && this.props.profit && this.props.basket && this.props.basket.length > 0 ? <SendRequestButton handleSendRequest={this.props.handleSendRequest}/> : null }
