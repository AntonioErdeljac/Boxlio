...
class  SendRequestButton extends React.Component {
    ...
    render(){
    return (
        <TouchableOpacityAnimatable animation="fadeInUp" ref="searchbutton" onPress={() => this.refs.searchbutton.fadeOutDown(100).then(this.props.navigation.navigate('basket'))}  style={styles.loginButton}>
            <CardItem style={{backgroundColor: 'transparent'}}>
                <Left>
                    <Icon name="shopping-basket" style={{color: '#fff', fontSize: 20}}/>
                </Left>
                <Text style={styles.loginButtonText}>Open basket</Text>
            </CardItem>
