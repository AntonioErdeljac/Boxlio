                    ...
                    <nav className="Absolute-Center float-modal-delivery-interface">
                        <div className="container">
                            ...
                            <div style={{color: 'rgba(0,0,0,.6)'}} className="text-center">
                                ...
                                <button disabled={this.props.inProgress} onClick={this.handleChangeAvailable} className="btn btn-primary" style={this.props.currentUser.available ? {backgroundColor: '#1fcf7c', borderStyle: 'none'} : {backgroundColor: '#E7475E', borderStyle: 'none'}}>{this.props.currentUser.available ? "Go Offline" : "Go Online" }</button>
                            </div>
