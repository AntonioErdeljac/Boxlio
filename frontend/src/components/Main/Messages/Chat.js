        ...
        <div className="header-messenger">
          {this.props.profile ?
            <div>
              ...
              <hr className="col-3" />
              <button
                disabled={this.props.currentUser.deliveryMode || !this.props.profile.deliveryMode || !this.props.profile.available || this.props.profile.isDelivering}
              ...
              >
                <i className="fa fa-truck" /> Request a delivery
              </button>
              <Link
                to={`/@${this.props.profile.username}`}
                className="mb-2 orderbtn btn btn-primary "
                style={{ backgroundColor: '#2d89e5', borderStyle: 'none' }}
              >
                <i className="fa fa-user" /> See Profile
              </Link>
            </div> : null}
        </div>
