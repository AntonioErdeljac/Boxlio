            ...
            return (
                ...
                <nav className="Absolute-Center float-modal-destination">
                    <div className="container">
                        ...
                        <button className="orderbtn btn btn-primary form-control" disabled={!this.state.price || !this.props.to || !this.props.from || !this.state.item ? true : false || !this.props.placeChoosen} onClick={this.handleSendRequest} style={{backgroundColor: '#1fcf7c', borderStyle: 'none'}}><i className="fa fa-search"></i> Find a delivery person</button>
                                :
