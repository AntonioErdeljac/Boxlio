		...
		if(this.props.profile){
			return (
				<div>
	                ...
	                <button disabled={this.state.text.length === 0 || this.state.text.length > 500} onClick={this.handleSubmit} className="orderbtn btn btn-primary my-3  float-md-right float-center"
