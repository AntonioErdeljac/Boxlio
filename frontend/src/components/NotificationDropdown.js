...
class NotificationDropdown extends React.Component{
    render(){
        return (
            <div style={{width: '180px', fontSize: '17px', borderStyle: 'none', marginTop: '10px', boxShadow: '0 0 10px 0 rgba(0,0,0,.1)', borderRadius: '3px', color:'rgba(0,0,0,.5)'}} className="dropdown-menu" aria-labelledby="navbarDropdown2" id="navdrop2">
